...
# [[https://www.ucm.es/themes/ucm16/media/img/logo.png][https://www.ucm.es/themes/ucm16/media/img/logo.png]]
...
Si $a_i=i$, $\forall i\in\mathbb{N}$ hemos descubierto que $\sum_{i=1}^4 a_i = 10$.
...
Y si puedes usa [[https://www.gnu.org/software/emacs/][emacs]], el mejor editor de mundo!
